...
class BeamSearch(Search):
    ...
    def step(
        ...
        beams_buf = torch.div(indices_buf, vocab_size, rounding_mode='trunc') # indices_buf // vocab_size
...
class PrefixConstrainedBeamSearch(Search):
    ...
    def apply_mask(self, x, prev_output_tokens, original_batch_idxs):
        beam_size = torch.div(x.shape[0],  original_batch_idxs.shape[0], rounding_mode='trunc') 
        original_batch_idxs = (
