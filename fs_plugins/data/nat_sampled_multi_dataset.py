...
class NATSampledMultiDataset(FairseqDataset):
    ...
    def filter_indices_by_size(self, indices, max_sizes, src_upsample_scale, min_sent_length):
        ...
        return filter_paired_dataset_indices_by_size(
            src_sizes, tgt_sizes, indices, max_sizes, src_upsample_scale, min_sent_length
        )


def filter_paired_dataset_indices_by_size(src_sizes, tgt_sizes, indices, max_sizes, src_upsample_scale, min_sent_length):
    """Filter a list of sample indices. Remove those that are longer
        than specified in max_sizes.
    ...
    indices = indices[src_sizes[indices] > min_sent_length]
    indices = indices[tgt_sizes[indices] > min_sent_length]

    indices = indices[src_sizes[indices] * FILTER_RATIO > tgt_sizes[indices]]
    indices = indices[tgt_sizes[indices] * FILTER_RATIO > src_sizes[indices]]
